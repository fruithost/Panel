                ...
                <tr>
                    <td scope="row" width="1px">
                        <div class="form-check">
                            <input class="form-check-input" type="checkbox" id="module_<?php print $info->getName(); ?>"
                                   name="module[]" value="<?php print $info->getName(); ?>"/>
                            <label class="form-check-label" for="module_<?php print $info->getName(); ?>"></label>
                        </div>
                    </td>
                    <td>
                        <span class="d-block badge badge-pill module-badge text-bg-<?php print ($module->isLocked() ? 'warning' : ($module->isEnabled() ? 'success' : 'danger')); ?>"
                              data-toggle="tooltip"
                              title="<?php ($module->isLocked() ? I18N::__('Module has depencies.') : ($module->isEnabled() ? I18N::__('Module is enabled.') : I18N::__('Module is disabled.'))); ?>"></span>
                    </td>
                    <td>
                    ...
                    <td>
                        ...
                        <small><span
                                    class="badge bg-secondary"><?php I18N::__('Version'); ?><?php print $info->getVersion(); ?></span>
                            | <?php I18N::__('by'); ?> <a href="<?php print $info->getAuthor()->getWebsite(); ?>"
                                                          target="_blank"><?php print $info->getAuthor()->getName(); ?></a></small>
                    </td>
                </tr>
				<?php
			}
