...
?>
    <ul class="nav nav-tabs" id="myTab" role="tablist">
        ...
        <li class="nav-item"><a class="nav-link<?php print (!empty($action) && $action === 'permissions' ? ' active' : ''); ?>" id="permissions-tab" href="<?php print $this->url(sprintf('/admin/users/%s/permissions', $tab)); ?>" role="tab"><?php I18N::__('Permissions'); ?></a></li>
    </ul>
<?php
	if(isset($error)) {
		?>
...
?>
    <div class="tab-content" id="myTabContent">
        ...
        <div class="tab-pane<?php print (!empty($action) && $action === 'permissions' ? ' show active' : ''); ?>" id="permissions" role="tabpanel" aria-labelledby="permissions-tab">
			<?php
