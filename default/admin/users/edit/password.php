	...
	<div class="row">
		<div class="col-3 border-right">
			<ul class="nav flex-column nav-tabs" role="tablist" aria-orientation="vertical">
				<li class="nav-item"><button class="nav-link active" id="security-tab" role="tab" data-toggle="tab" data-target="#security"><?php I18N::__('Security settings'); ?></button></li>
				<li class="nav-item"><button class="nav-link" id="manual-tab" role="tab" data-toggle="tab" data-target="#manual"><?php I18N::__('Change password manually'); ?></button></li>
				<li class="nav-item"><button class="nav-link" id="recover-tab" role="tab" data-toggle="tab" data-target="#recover"><?php I18N::__('Initiate password reset'); ?></button></li>
				<li class="nav-item"><button class="nav-link" id="generate-tab" role="tab" data-toggle="tab" data-target="#generate"><?php I18N::__('Generate new password'); ?></button></li>
			</ul>
		</div>
		<div class="col-9 p-4">
					...
					<div class="form-group row">
						...
						<div class="col-sm-10">
							<div class="custom-control custom-checkbox">
								<input class="custom-control-input" type="checkbox" name="2fa_enabled" id="2fa_enabled" value="true"<?php print ($user->getSettings('2FA_ENABLED', NULL, 'false') === 'true' ? ' CHECKED' : ''); ?> />
