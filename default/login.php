<?php
	...
	<form class="form-signin text-center" method="post" action="<?php print $template->url(true); ?>">
		...
		<h1 class="h3 mb-3 font-weight-normal"><?php I18N::__('Please sign in'); ?></h1>
		<?php
			if(isset($error)) {
				?>
			...
			if(isset($two_factor) && $two_factor) {
				?>
					<div class="form-label-group text-left">
						<input type="text" id="code" name="code" class="form-control" placeholder="<?php I18N::__('Code'); ?>" required autofocus />
				...
				?>
					<div class="form-label-group text-left">
						<input type="text" id="username" name="username" class="form-control" placeholder="<?php I18N::__('Username'); ?>" required autofocus value="<?php print $username; ?>" />
						<label for="username"><?php I18N::__('Username'); ?></label>
					</div>
					<div class="form-label-group text-left">
						<input type="password" id="password" name="password" class="form-control" placeholder="<?php I18N::__('Password'); ?>" required>
				...
				<div class="dropdown-menu">
					<?php
						foreach(I18N::getLanguages() AS $code => $language) {
							printf('<a class="dropdown-item" href="%s">%s</a>', $template->url('/login?lang=' . $code), $language);
						}
					?>
				</div>
			</div>
