...
?>
    <main class="form-signin w-100 m-auto text-center">
        <form method="post" action="<?php print $template->url(true); ?>">
				...
				if(isset($two_factor) && $two_factor) {
                    ...
                    <div class="form-floating">
                        <input type="code" class="form-control" id="code" name="code"
                               placeholder="<?php I18N::__('Code'); ?>" autocomplete="off" required autofocus/>
                        <br/>
                    ...
                    <div class="form-floating">
                        <input type="text" class="form-control" id="username" name="username"
                               placeholder="<?php I18N::__('Username'); ?>"
                               value="<?php print (isset($username) ? $username : ''); ?>" required autofocus/>
                        <label for="username"><?php I18N::__('Username'); ?></label>
                    </div>
                    <div class="form-floating">
                        <input type="password" class="form-control" id="password" name="password"
                               placeholder="<?php I18N::__('Password'); ?>" required/>
                        <label for="password"><?php I18N::__('Password'); ?></label>
                    </div>

                    <div class="mb-3 mt-3 text-end">
                        <a class="icon-link icon-link-hover" style="--bs-link-hover-color-rgb: 25, 135, 84;"
                           href="<?php print $template->url('/lost-password'); ?>">
							<?php I18N::__('Lost password'); ?>
            ...
            <div class="btn-group btn-group-lg" style="width: 100%;">
				...
				?>
                <button type="button" class="col-3 btn btn-secondary dropdown-toggle dropdown-toggle-split"
    ...
    <main class="w-200 m-auto text-center">
        <p class="mt-5 mb-3 text-body-secondary">
			<?php
				if($project_copyright) {
					print('<p class="mt-5 mb-3 text-muted">');
