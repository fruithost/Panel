<?php
	...
	<form class="form-password text-center" method="post" action="<?php print $template->url(true); ?>">
		...
		<h1 class="h3 mb-3 font-weight-normal"><?php I18N::__('Reset your Password'); ?></h1>
		<?php
			if(isset($error)) {
				?>
				...
				if(isset($changeable) && $changeable) {
					?>
						<div class="form-label-group text-left">
							<input type="password" id="password_new" name="password_new" class="form-control" placeholder="<?php I18N::__('New Password'); ?>" required autofocus />
							<label for="password_new"><?php I18N::__('New Password'); ?></label>
						</div>
						<div class="form-label-group text-left">
							<input type="password" id="password_repeated" name="password_repeated" class="form-control" placeholder="<?php I18N::__('Password Confirmation'); ?>" required autofocus />
					...
					?>
						<div class="form-label-group text-left">
							<input type="email" id="email" name="email" class="form-control" placeholder="<?php I18N::__('E-Mail'); ?>" required autofocus value="<?php print $email; ?>" />
							<label for="email"><?php I18N::__('E-Mail'); ?></label>
						</div>
					<?php
				}
			}
		...
		<div class="checkbox mb-3 mt-3 row text-left">
			<a class="col-12 text-left" href="<?php print $template->url('/login'); ?>"><i class="material-icons">arrow_left</i> <?php I18N::__('Back to the login'); ?></a>
		</div>
		<?php
			if(!isset($success)) {
				?>
