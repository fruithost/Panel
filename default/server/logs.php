<?php
	...
	$template->header();
	if(!Auth::hasPermission('SERVER::LOGFILES')) {
		?>
    ...
    <form method="post" action="<?php print $this->url('/server/logs'); ?>">
            ...
            <header class="page-header d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3">
                ...
                <div class="btn-toolbar mb-2 mb-md-0">
                    <button type="submit" name="action" value="refresh"
                            class="btn btn-sm btn-outline-primary"><?php I18N::__('Refresh'); ?></button>
                </div>
            </header>
        ...
        <aside class="bg-body-tertiary border-start contentbar d-md-block">
            <h6 class="sidebar-heading d-flex justify-content-between align-items-center px-3 mt-2 mb-2 text-muted"
                data-toggle="collapse" data-target="#collapse_account" aria-expanded="false"
