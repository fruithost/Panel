...
?>
    <header class="page-header d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3">
        ...
        <div class="btn-toolbar mb-2 mb-md-0">
            <a href="<?php print $this->url('/server/network'); ?>"
                        ...
                        <div class="col card text-break p-0 m-2">
                            ...
                            <div class="card-body p-1 text-center">
                                <a class="icon-link icon-link-hover text-decoration-none"
                                   ...
                                   href="<?php print $template->url('/server/network/'.$entry->getID().'/info'); ?>">
									<?php
										Icon::show('info', [
											'classes' => [ 'mb-2' ]
										]);
                                ...
                                <a class="icon-link icon-link-hover text-decoration-none"
                                   style="--bs-link-hover-color-rgb: 25, 135, 84;"
                                   href="<?php print $template->url('/server/network/'.$entry->getID().'/stop'); ?>">
									<?php
										switch($entry->getState()) {
											case NetworkState::UP:
												Icon::show('network', [
					...
					if($device->hasAddresses()) {
                        ...
                        <div class="border rounded overflow-hidden mb-5 p-0">
                            <table class="table table-borderless table-striped table-hover m-0 p-0">
                                <thead>
                                <tr>
                                    <th class="bg-secondary-subtle" scope="col"
                                        style="width: 20px;"><?php I18N::__('Type'); ?></th>
                                    ...
                                    <th class="bg-secondary-subtle" scope="col"
                                        style="width: 20px;"><?php I18N::__('TTL'); ?></th>
                                </tr>
                                </thead>
                                <tbody>
								<?php
