                ...
                <div class="card-body p-0">
                    <table class="table m-0 table-borderless table-striped">
                        ...
                        <tr>
                            ...
                            <td>
								<?php print $daemon['start']; ?>
                                (<?php printf(I18N::get('%s ago'), Utils::getTimeDifference($daemon['started'])); ?>)
                            </td>
                        </tr>
                        <tr>
                            <td>
                            ...
                            <td>
								<?php print $daemon['end']; ?>
                                (<?php printf(I18N::get('%s ago'), Utils::getTimeDifference($daemon['ended'])); ?>)
                            </td>
                        </tr>
                        <tr>
                            <td>
