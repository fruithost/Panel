...
?>
    <form method="post" action="<?php print $this->url('/server/settings'.(!empty($tab) ? '/'.$tab : '')); ?>">
        ...
        <div class="tab-content">
            <div class="tab-pane<?php print (empty($tab) ? ' show active' : ''); ?>" id="globals" role="tabpanel"
                 aria-labelledby="globals-tab">
                ...
                <div class="container">
                    ...
                    <div class="form-group text-end">
                        <button type="submit" name="action" value="save"
                                class="btn btn-outline-success"><?php I18N::__('Save'); ?></button>
                    </div>
                </div>
            </div>
        </div>
